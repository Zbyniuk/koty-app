...
export default function DashboardScreen() {
  ...
  return (
    ...
    >
      ...
      >
        <Text style={styles.searchTileIcon}>🔍</Text>
        <Text style={styles.searchTileTitle}>SZUKAJ</Text>
        <Text style={styles.searchTileSub}>
          Przeszukaj koty mioty właścicieli i przyszłe dane systemu
        </Text>
      </Pressable>
